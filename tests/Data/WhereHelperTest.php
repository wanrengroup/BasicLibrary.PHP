...
class WhereHelperTest extends LocalTestCase
{
    /**
     ...
     * @return void
     */
    private function assertDetails($where, int $expectCount = 0): void
    {
    ...
    {
        parent::setUp();
        $this->logic = new GeneralLogic("where_helper_testing");
    }
